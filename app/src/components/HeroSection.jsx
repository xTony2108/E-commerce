      ...
      <div className="relative bg-primary">
        <div className="relative max-w-screen-2xl m-auto display flex items-center min-h-[calc(100svh-112px)] max-2xl:max-w-screen-lg">
          <div className="flex flex-col gap-4 flex-1">
            <h1 className="font-black text-5xl text-gghYellow max-2xl:text-4xl">
              GamerGear Hub: potenzia il tuo gioco, vivi la vittoria!
            </h1>
            <p className="text-white text-lg font-normal max-2xl:text-base">
              Scopri il potenziale del tuo setup gaming con GamerGear Hub!
              Scegli i componenti di ultima generazione per un'esperienza di
              gioco straordinaria. Entra nel mondo dell'alta performance,
