    ...
    <>
      <div className="bg-bg py-20">
        <div className="max-w-screen-2xl m-auto">
          ...
          <div className="flex justify-between items-center border-b border-border pb-8 text-secondary font-semibold">
            <span className="pl-6">
            ...
            <div className="flex gap-6 justify-center items-center pr-6">
              ...
              />
              <button className="border border-border py-1 px-10 rounded-lg text-md">Altri filtri</button>
            </div>
          </div>
          <div className="flex py-20 gap-5 items-start px-6" ref={scrollRef}>
            <SpecialOffers />
